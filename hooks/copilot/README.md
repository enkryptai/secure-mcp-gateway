...
└── hooks/
    ...
    ├── enkrypt_guardrails.py           (moved to src/enkryptai_agent_security/hooks/providers/copilot.py)
    ...
    └── tests/
        └── test_enkrypt_guardrails.py  (moved to tests/hooks/copilot/)
...
```python
from enkryptai_agent_security.hooks.providers.copilot import get_hook_metrics, reset_metrics
