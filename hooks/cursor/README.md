...
└── hooks/
    ...
    ├── enkrypt_guardrails.py           (moved to src/enkryptai_agent_security/hooks/providers/cursor.py)
    ...
    └── tests/
        └── test_enkrypt_guardrails.py  (moved to tests/hooks/cursor/)
```
...
```python
from enkryptai_agent_security.hooks.providers.cursor import get_hook_metrics, reset_metrics
