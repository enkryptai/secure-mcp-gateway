...
└── hooks/
    ...
    ├── enkrypt_guardrails.py           (moved to src/enkrypt_security/hooks/providers/cursor.py)
...
```python
from enkrypt_security.hooks.providers.cursor import get_hook_metrics, reset_metrics
