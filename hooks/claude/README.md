...
└── hooks/
    ...
    ├── enkrypt_guardrails.py           (moved to src/enkryptai_agent_security/hooks/providers/claude.py)
    ...
    └── tests/
        └── test_enkrypt_guardrails.py  (moved to tests/hooks/claude/)
```
...
```python
from enkryptai_agent_security.hooks.providers.claude import get_hook_metrics, reset_metrics
