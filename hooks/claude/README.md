...
└── hooks/
    ...
    ├── enkrypt_guardrails.py           (moved to src/enkrypt_security/hooks/providers/claude.py)
...
```python
from enkrypt_security.hooks.providers.claude import get_hook_metrics, reset_metrics
