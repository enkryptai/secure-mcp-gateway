...
- This generates the config file at the path specified in the command

  ```bash
  secure-mcp-gateway generate-config --config-path <path/to/enkrypt_mcp_config.json>

  # Example below to generate in the current directory
  secure-mcp-gateway generate-config --config-path enkrypt_mcp_config.json
  ```
...
--------------------------------
SYSTEM INFO:
Using Python interpreter: C:\Users\user\Documents\GitHub\enkryptai\secure-mcp-gateway\.secure-mcp-gateway-venv\Scripts\python.exe
Python version: 3.13.3 (tags/v3.13.3:6280bb5, Apr  8 2025, 14:47:33) [MSC v.1943 64 bit (AMD64)]
Current working directory: C:\Users\user\Documents\GitHub\enkryptai\secure-mcp-gateway
PYTHONPATH: Not set
--------------------------------
...
config_path: C:\Users\user\Documents\GitHub\enkryptai\secure-mcp-gateway\.secure-mcp-gateway-venv\Lib\enkrypt_mcp_config.json
example_config_path: C:\Users\user\Documents\GitHub\enkryptai\secure-mcp-gateway\.secure-mcp-gateway-venv\Lib\example_enkrypt_mcp_config.json
Both config file or example config file not found. Defaulting to hard coded config
CONFIG:
...
Generated default config at enkrypt_mcp_config.json
```
...
```json
{
  ...
  "gateways": {
    "5JL4SnUU9uPJJESzMdNg2Tmv1KgwlIe19YAAIlDoNnjjCZYH": {
      "id": "b35c6db9-0654-4f96-86d6-0b8e17fc5338",
      "mcp_config": [
        {
...
- Run the following command to install the gateway for Claude:
  ...
  ```bash
  secure-mcp-gateway install --client claude-desktop --config-path enkrypt_mcp_config.json
  ```
...
Error: Gateway key is required. Please update your mcp client config and try again.
Getting Enkrypt Common Configuration
config_path: C:\Users\PC\Documents\GitHub\enkryptai\secure-mcp-gateway\.secure-mcp-gateway-venv\Lib\enkrypt_mcp_config.json
example_config_path: C:\Users\PC\Documents\GitHub\enkryptai\secure-mcp-gateway\.secure-mcp-gateway-venv\Lib\example_enkrypt_mcp_config.json
Both config file or example config file not found. Defaulting to hard coded config
CONFIG:
ENKRYPT_GATEWAY_KEY: ****NULL
enkrypt_log_level: info
...
--------------------------------
External Cache is not enabled. Using local cache only.
config_path:  enkrypt_mcp_config.json
  ...
  ```json
  {
    "mcpServers": {
      "Enkrypt Secure MCP Gateway": {
        ...
        "env": {
          "ENKRYPT_GATEWAY_KEY": "5JL4SnUU9uPJJESzMdNg2Tmv1KgwlIe19YAAIlDoNnjjCZYH"
        }
      }
    }
  }
...
- Run the CLI Install Command for Cursor
  ...
  ```bash
  secure-mcp-gateway install --client cursor --config-path <path/to/enkrypt_mcp_config.json>
  ```
