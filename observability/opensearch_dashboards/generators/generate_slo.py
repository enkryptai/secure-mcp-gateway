...
PANEL_SPECS = [
    ...
    (kpi_metric_vis("Tool Calls (total)", custom_label="Total"),
        'name : "enkrypt.tool.calls"', METRICS_DATAVIEW_ID, (0, 38, 8, 6)),
    ...
    (time_series_vis("Tool Calls/sec", "Tool Calls", chart_type="histogram"),
        'name : "enkrypt.tool.calls"', METRICS_DATAVIEW_ID, (0, 44, 24, 12)),
    (area_vis(
        ...
        'name : "enkrypt.tool.calls"', METRICS_DATAVIEW_ID, (24, 44, 24, 12)),
    (area_vis(
    ...
    (kpi_metric_vis("Tool Errors", custom_label="Errors"),
        'name : "enkrypt.tool.errors"', METRICS_DATAVIEW_ID, (0, 70, 8, 6)),
    ...
    (time_series_vis("Tool Error Rate", "Errors", chart_type="histogram"),
        'name : "enkrypt.tool.errors"', METRICS_DATAVIEW_ID, (0, 76, 24, 12)),
    (area_vis(
