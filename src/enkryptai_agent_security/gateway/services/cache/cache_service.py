...
class CacheService:
    ...
    def _initialize_cache(self):
        ...
        if self.use_external_cache:
            ...
            try:
                from enkryptai_agent_security.gateway.client import initialize_cache
    ...
    def cache_tools(
        ...
        """
        try:
            from enkryptai_agent_security.gateway.client import cache_tools
    ...
    def get_cached_tools(
        ...
        """
        try:
            from enkryptai_agent_security.gateway.client import get_cached_tools
    ...
    def cache_gateway_config(self, gateway_id: str, config: Dict[str, Any]) -> bool:
        ...
        """
        try:
            from enkryptai_agent_security.gateway.client import cache_gateway_config
    ...
    def get_cached_gateway_config(
        ...
        """
        try:
            from enkryptai_agent_security.gateway.client import get_cached_gateway_config
    ...
    def clear_cache_for_servers(self, id: str, server_name: str = None) -> int:
        ...
        """
        try:
            from enkryptai_agent_security.gateway.client import clear_cache_for_servers
    ...
    def clear_gateway_config_cache(self, id: str, gateway_key: str) -> bool:
        ...
        """
        try:
            from enkryptai_agent_security.gateway.client import clear_gateway_config_cache
    ...
    def get_cache_statistics(self) -> Dict[str, Any]:
        ...
        """
        try:
            from enkryptai_agent_security.gateway.client import get_cache_statistics
    ...
    def get_server_hashed_key(self, id: str, server_name: str) -> str:
        ...
        """
        try:
            from enkryptai_agent_security.gateway.client import get_server_hashed_key
    ...
    def get_gateway_config_hashed_key(self, gateway_key: str) -> str:
        ...
        """
        try:
            from enkryptai_agent_security.gateway.client import get_gateway_config_hashed_key
    ...
    def get_id_from_key(self, key: str) -> str:
        ...
        """
        try:
            from enkryptai_agent_security.gateway.client import get_id_from_key
    ...
    def cache_key_to_id(self, key: str) -> str:
        ...
        """
        try:
            from enkryptai_agent_security.gateway.client import cache_key_to_id
