...
from enkryptai_agent_security.telemetry import (
    SourceEvent,
    SourceProduct,
    SpanAttributes,
    SpanNames,
)
from enkryptai_agent_security.gateway.plugins.auth import AuthCredentials, get_auth_config_manager
        ...
        with tracer.start_as_current_span(
            ...
            if use_plugins:
                ...
                if not local_config:
                    ...
                    from enkryptai_agent_security.gateway.error_handling import create_error_response
                ...
                if not self.auth_manager.is_session_authenticated(session_key):
                    ...
                    if result.get("status") != "success":
                        ...
                        from enkryptai_agent_security.gateway.error_handling import (
    ...
    async def _execute_with_input_guardrails(
        ...
        with tracer.start_as_current_span(
            ...
            if guardrail_response is None:
                ...
                from enkryptai_agent_security.gateway.error_handling import error_logger
                from enkryptai_agent_security.gateway.exceptions import (
                    ErrorCode,
                    ErrorContext,
