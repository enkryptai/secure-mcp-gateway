...
from enkryptai_agent_security.gateway.services.oauth.models import OAuthConfig
from enkryptai_agent_security.gateway.services.oauth.oauth_service import get_oauth_service
...
async def prepare_oauth_for_server(
    ...
    if oauth_config.grant_type.value == "authorization_code":
        ...
        from enkryptai_agent_security.gateway.services.oauth.token_manager import get_token_manager
