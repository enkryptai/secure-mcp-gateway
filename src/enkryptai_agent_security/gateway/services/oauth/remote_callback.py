...
from enkryptai_agent_security.gateway.services.oauth import OAuthConfig, OAuthToken
...
async def authorize_with_auto_detection(
    ...
    if is_remote_callback(oauth_config.redirect_uri):
        ...
        from enkryptai_agent_security.gateway.services.oauth.browser_auth import (
