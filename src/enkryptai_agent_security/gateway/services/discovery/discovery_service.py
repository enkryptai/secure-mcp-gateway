...
from enkryptai_agent_security.telemetry import SourceProduct, SpanAttributes, SpanNames
from enkryptai_agent_security.gateway.client import forward_tool_call

# Telemetry components will be obtained lazily when needed
from enkryptai_agent_security.gateway.error_handling import create_error_response, error_logger
...
from enkryptai_agent_security.gateway.plugins.telemetry import get_telemetry_config_manager
from enkryptai_agent_security.gateway.services.cache.cache_service import cache_service
...
class DiscoveryService:
    ...
    async def _check_authentication(
        ...
        if not self.auth_manager.is_session_authenticated(session_key):
            with tracer_obj.start_as_current_span(SpanNames.AUTH) as auth_span:
                ...
                from enkryptai_agent_security.gateway.gateway import enkrypt_authenticate
    ...
    async def _discover_all_servers(
        ...
        with tracer_obj.start_as_current_span(SpanNames.DISCOVERY) as all_span:
            ...
            # Import here to avoid circular imports
            from enkryptai_agent_security.gateway.gateway import enkrypt_list_all_servers
    ...
    async def _discover_single_server(
        ...
        with tracer_obj.start_as_current_span(SpanNames.DISCOVERY) as info_span:
            ...
            if config_tools:
                ...
                try:
                    from enkryptai_agent_security.gateway.client import get_server_metadata_only
