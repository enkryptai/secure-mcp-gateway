...
from enkryptai_agent_security.gateway.cli import (
    add_config,
...
async def global_exception_handler(request, exc):
    ...
    from enkryptai_agent_security.gateway.utils import mask_sensitive_headers
...
try:
    from enkryptai_agent_security.gateway.api_routes import router as additional_routes
...
def main():
    ...
    uvicorn.run(
        "enkryptai_agent_security.gateway.api_server:app",
        host="0.0.0.0",
        port=8001,
        reload=False,
        log_level="info",
