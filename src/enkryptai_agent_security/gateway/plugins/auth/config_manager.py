...
from enkryptai_agent_security.gateway.plugins.auth.base import (
    AuthCredentials,
    AuthProvider,
...
def convert_legacy_format_to_auth_result(legacy_result: Dict[str, Any]) -> AuthResult:
    ...
    Returns:
        AuthResult object
    """
    from enkryptai_agent_security.gateway.plugins.auth.base import AuthStatus
...
def initialize_auth_system(config: Dict[str, Any] = None) -> AuthConfigManager:
    ...
    from enkryptai_agent_security.gateway.plugins.plugin_loader import PluginLoader
