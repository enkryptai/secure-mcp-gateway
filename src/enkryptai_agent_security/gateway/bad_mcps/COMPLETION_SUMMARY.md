...
```bash
python -m src.enkryptai_agent_security.gateway.bad_mcps.unauthenticated_access_mcp
python -m src.enkryptai_agent_security.gateway.bad_mcps.rce_mcp
python -m src.enkryptai_agent_security.gateway.bad_mcps.prompt_injection_mcp
python -m src.enkryptai_agent_security.gateway.bad_mcps.ssrf_mcp
```
