...
class EnkryptAgentHooks(AgentHooksBase):
    ...
    Example:
        ...
        from enkryptai_agent_security.hooks.wrappers.openai_hook import EnkryptAgentHooks
...
async def run_with_guardrails(
    ...
    **runner_kwargs
    ...
    Example:
        ```python
        from agents import Agent
        from enkryptai_agent_security.hooks.wrappers.openai_hook import run_with_guardrails
