...
logger = logging.getLogger("enkryptai_agent_security.telemetry")
...
def init_telemetry(
    *,
    ...
    if not _OTEL_AVAILABLE:
        if exporter != ExporterType.NONE:
            logger.info(
                ...
                "Install with: pip install enkryptai-agent-security[otel]"
            )
    ...
    tracer = tracer_provider.get_tracer("enkryptai_agent_security")
    ...
    meter = meter_provider.get_meter("enkryptai_agent_security")
