"""OpenTelemetry bootstrap — delegates to the shared ``enkryptai_agent_security`` package.
...
from enkryptai_agent_security.telemetry.setup import TelemetryContext, is_otel_available
from enkryptai_agent_security.telemetry.setup import init_telemetry as _shared_init_telemetry
