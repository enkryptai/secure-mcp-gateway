...
log = logging.getLogger("enkryptai_agent_security.sdk.patch.semantic_kernel")
...
def install(
    ...
    global _installed, _filter, _orig_get_chat, AGENT_ID
    if _installed:
        return
    if agent_id:
        AGENT_ID = agent_id
    ...
    _filter = EnkryptSKFilter(observer, guard_engine, agent_id=AGENT_ID)
