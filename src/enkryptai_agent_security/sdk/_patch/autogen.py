...
from enkryptai_agent_security.sdk.events import AgentEvent, EventName, new_run_id
...
log = logging.getLogger("enkryptai_agent_security.sdk.patch.autogen")
...
def install(
    ...
    global _installed, _orig_run, _orig_initiate_chat, _orig_a_initiate_chat, _api_version, AGENT_ID
    if _installed:
        return
    if agent_id:
        AGENT_ID = agent_id
