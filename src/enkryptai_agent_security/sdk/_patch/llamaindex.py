...
log = logging.getLogger("enkryptai_agent_security.sdk.patch.llamaindex")
...
def install(
    ...
    global _installed, _handler, _orig_tool_call, _orig_agent_chat, _orig_agent_achat, AGENT_ID
    if _installed:
        return
    if agent_id:
        AGENT_ID = agent_id
    ...
    _handler = EnkryptLlamaIndexHandler(observer, guard_engine, agent_id=AGENT_ID)
