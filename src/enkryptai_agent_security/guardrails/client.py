...
logger = logging.getLogger("enkryptai_agent_security.guardrails")
...
class EnkryptGuardrailClient:
    ...
    def __init__(
        ...
        source_name: str = "enkryptai-agent-security",
        max_retries: int = 3,
    ) -> None:
    ...
    async def _apost_json(
        ...
        try:
            ...
            raise ImportError(
                ...
                "Install with: pip install enkryptai-agent-security[sdk]"
            ) from exc
