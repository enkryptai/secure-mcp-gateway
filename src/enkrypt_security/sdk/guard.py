...
from enkrypt_security.sdk.encoding import decode_if_encoded
from enkrypt_security.sdk.events import AgentEvent, EventName, GuardrailAction, GuardrailVerdict
from enkrypt_security.sdk.exceptions import (
    GuardrailAPIError,
...
class GuardEngine:
    ...
    def __init__(
        ...
        *,
        ...
        if registry is None:
            from enkrypt_security.sdk.guardrails.base import GuardrailRegistry as _Reg
    ...
    async def check_input(self, content: str, *, tool_name: str | None = None) -> GuardrailVerdict:
        ...
        """
        import logging
        log = logging.getLogger("enkrypt_security.sdk.guard")
