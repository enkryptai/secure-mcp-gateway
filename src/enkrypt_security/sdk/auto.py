...
Usage — explicit config::
    ...
    from enkrypt_security.sdk import auto_secure, SDKConfig, GuardrailConfig

    auto_secure(SDKConfig(
        enkrypt_api_key="ek-...",
        input_guardrails=GuardrailConfig(enabled=True, guardrail_name="My Policy",
...
from enkrypt_security.sdk import _state
from enkrypt_security.sdk.config import GuardrailConfig, SDKConfig
from enkrypt_security.sdk.otel_setup import ExporterType
from enkrypt_security.sdk.redaction import PayloadPolicy

# Registry: framework_name → (import_probe_module, patch_module_path)
_REGISTRY: dict[str, tuple[str, str]] = {
    "langchain": ("langchain_core", "enkrypt_security.sdk._patch.langchain"),
    "langgraph": ("langgraph", "enkrypt_security.sdk._patch.langgraph"),
    "openai_agents": ("agents", "enkrypt_security.sdk._patch.openai_agents"),
    "anthropic": ("anthropic", "enkrypt_security.sdk._patch.anthropic"),
    "crewai": ("crewai", "enkrypt_security.sdk._patch.crewai"),
    "pydantic_ai": ("pydantic_ai", "enkrypt_security.sdk._patch.pydantic_ai"),
    "llamaindex": ("llama_index.core", "enkrypt_security.sdk._patch.llamaindex"),
    "google_adk": ("google.adk", "enkrypt_security.sdk._patch.google_adk"),
    "bedrock_agents": ("botocore", "enkrypt_security.sdk._patch.bedrock_agents"),
    "autogen": ("autogen_agentchat", "enkrypt_security.sdk._patch.autogen"),
    "semantic_kernel": ("semantic_kernel", "enkrypt_security.sdk._patch.semantic_kernel"),
    "haystack": ("haystack", "enkrypt_security.sdk._patch.haystack"),
    "smolagents": ("smolagents", "enkrypt_security.sdk._patch.smolagents"),
    "phidata": ("phi", "enkrypt_security.sdk._patch.phidata"),
}
