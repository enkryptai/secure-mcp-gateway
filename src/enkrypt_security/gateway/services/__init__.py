...
def get_cache_service():
    from enkrypt_security.gateway.services.cache import cache_service

    return cache_service


def get_cache_management_service():
    from enkrypt_security.gateway.services.cache import get_cache_management_service as _get

    return _get()


def get_cache_status_service():
    from enkrypt_security.gateway.services.cache import get_cache_status_service as _get

    return _get()


def get_discovery_service():
    from enkrypt_security.gateway.services.discovery import discovery_service

    return discovery_service


def get_secure_tool_execution_service():
    from enkrypt_security.gateway.services.execution import SecureToolExecutionService

    return SecureToolExecutionService()


def get_server_info_service():
    from enkrypt_security.gateway.services.server import ServerInfoService

    return ServerInfoService()


def get_server_listing_service():
    from enkrypt_security.gateway.services.server import ServerListingService
...
def get_tool_execution_service():
    from enkrypt_security.gateway.services.execution import ToolExecutionService
