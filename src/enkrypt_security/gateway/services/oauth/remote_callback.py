...
from enkrypt_security.gateway.services.oauth import OAuthConfig, OAuthToken
from enkrypt_security.gateway.services.oauth.oauth_service import get_oauth_service
...
async def authorize_with_auto_detection(
    ...
    if is_remote_callback(oauth_config.redirect_uri):
        ...
        from enkrypt_security.gateway.services.oauth.browser_auth import (
