...
class ServerInfoService:
    ...
    async def _get_server_info(
        ...
        with tracer.start_as_current_span(SpanNames.VALIDATION) as server_span:
    ...
    async def _get_latest_server_info(
        ...
        with tracer.start_as_current_span(SpanNames.DISCOVERY_CACHE_CHECK) as info_span:
            ...
            from enkrypt_security.gateway.services.cache.cache_service import CacheService
