...
# BASE_DIR = os.path.dirname(enkrypt_security.gateway.__file__)
BASE_DIR = files("enkrypt_security.gateway")
if BASE_DIR not in sys.path:
    sys.path.insert(0, BASE_DIR)

from enkrypt_security.gateway.utils import (
    CONFIG_PATH,
    DOCKER_CONFIG_PATH,
    clear_config_cache,
    is_docker,
...
def generate_unified_config(
    *,
    ...
    """
    from enkrypt_security.config.hook_defaults import PLATFORM_DEFAULTS
    ...
    # -- SDK section --
    if include_sdk:
        ec.extra["sdk"] = SDKSection(provider_keys=ProviderKeysConfig())
...
def start_api_server(host="0.0.0.0", port=8001, reload=False):
    ...
    try:
        ...
        from enkrypt_security.gateway.api_server import app
...
def main():
    ...
    # =========================================================================
        ...
        if include_all:
            from enkrypt_security.config.hook_defaults import SUPPORTED_PLATFORMS
