...
class PluginLoader:
    ...
    DEFAULT_PROVIDERS: ClassVar[Dict[str, Dict[str, str]]] = {
        "auth": {
            "class": "enkrypt_security.gateway.plugins.auth.local_apikey_provider.LocalApiKeyProvider",
            "name": "enkrypt",
        },
        "guardrails": {
            "class": "enkrypt_security.gateway.plugins.guardrails.enkrypt_provider.EnkryptGuardrailProvider",
            "name": "enkrypt",
        },
        "telemetry": {
            "class": "enkrypt_security.gateway.plugins.telemetry.opentelemetry_provider.OpenTelemetryProvider",
            "name": "opentelemetry",
        },
    }
    ...
    def load_plugin_providers(
        ...
        """
        from enkrypt_security.gateway.plugins.provider_loader import (
        ...
        if plugin_config and "provider" in plugin_config:
            ...
            provider_class_mapping = {
                ...
                "local_apikey": "enkrypt_security.gateway.plugins.auth.local_apikey_provider.LocalApiKeyProvider",
