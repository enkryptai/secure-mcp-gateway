...
def load_provider_class(class_path: str) -> type:
    ...
    Example:
        >>> cls = load_provider_class("enkrypt_security.gateway.plugins.guardrails.example_providers.OpenAIGuardrailProvider")
    ...
    Example Config:
        {
            ...
            "class": "enkrypt_security.gateway.plugins.guardrails.example_providers.OpenAIGuardrailProvider",
            "config": {
                "api_key": "sk-xxx"
            }
        }
