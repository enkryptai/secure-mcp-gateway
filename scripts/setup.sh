...
cp $SCRIPT_DIR/../src/enkryptai_agent_security/gateway/$example_enkrypt_mcp_config_file $enkrypt_mcp_config_file
...
cd $SCRIPT_DIR/../src/enkryptai_agent_security/gateway/bad_mcps
