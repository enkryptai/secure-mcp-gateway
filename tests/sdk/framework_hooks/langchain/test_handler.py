...
Run with: pytest tests/sdk/framework_hooks/langchain/test_handler.py -v
"""
import pytest
import sys
import os
...
class TestSensitiveToolBlocking:
    ...
    @patch('enkryptai_agent_security.sdk.framework_hooks.langchain_handler.is_hook_enabled', return_value=False)
    @patch('enkryptai_agent_security.sdk.framework_hooks.langchain_handler.is_sensitive_tool', return_value=True)
...
class TestLLMCallbacks:
    ...
    @patch('enkryptai_agent_security.sdk.framework_hooks.langchain_handler.check_with_enkrypt_api')
    @patch('enkryptai_agent_security.sdk.framework_hooks.langchain_handler.is_hook_enabled', return_value=True)
...
class TestToolCallbacks:
    ...
    @patch('enkryptai_agent_security.sdk.framework_hooks.langchain_handler.is_hook_enabled', return_value=False)
    @patch('enkryptai_agent_security.sdk.framework_hooks.langchain_handler.is_sensitive_tool', return_value=False)
