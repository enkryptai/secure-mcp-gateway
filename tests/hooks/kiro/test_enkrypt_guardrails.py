...
from enkrypt_security.hooks.providers.kiro import (
...
class TestMetricsCollector(unittest.TestCase):
    ...
    def setUp(self):
        ...
        from enkrypt_security.hooks.providers.kiro import reset_metrics
        reset_metrics()

    def test_record_call(self):
        """Test recording a hook call."""
        from enkrypt_security.hooks.providers.kiro import metrics, get_hook_metrics
    ...
    def test_reset_metrics(self):
        ...
        from enkrypt_security.hooks.providers.kiro import metrics, get_hook_metrics, reset_metrics
        metrics.record_call("test_hook", blocked=False, latency_ms=100.0)
...
class TestConfigValidation(unittest.TestCase):
    ...
    def test_valid_config(self):
        ...
        from enkrypt_security.hooks.providers.kiro import validate_config
        config = {
            "enkrypt_api": {
...
class TestConnectionPooling(unittest.TestCase):
    ...
    def test_session_creation(self):
        ...
        from enkrypt_security.hooks.providers.kiro import get_http_session
...
class TestPrecompiledPatterns(unittest.TestCase):
    ...
    def test_patterns_are_compiled(self):
        ...
        import re
        from enkrypt_security.hooks.providers.kiro import SENSITIVE_PATTERNS
...
class TestBaseHookClass(unittest.TestCase):
    ...
    def test_input_guardrail_hook_defaults(self):
        ...
        from enkrypt_security.hooks.providers.kiro import InputGuardrailHook
    ...
    def test_output_audit_hook_defaults(self):
        ...
        from enkrypt_security.hooks.providers.kiro import OutputAuditHook
    ...
    def test_base_hook_is_enabled_property(self):
        ...
        from enkrypt_security.hooks.providers.kiro import BaseHook
...
class TestBufferedLogger(unittest.TestCase):
    ...
    def test_buffered_logger_creation(self):
        ...
        from enkrypt_security.hooks.providers.kiro import BufferedLogger
...
class TestLogRetention(unittest.TestCase):
    ...
    def test_log_retention_days_default(self):
        ...
        from enkrypt_security.hooks.providers.kiro import LOG_RETENTION_DAYS
    ...
    def test_cleanup_old_logs_exists(self):
        ...
        from enkrypt_security.hooks.providers.kiro import cleanup_old_logs
...
class TestDynamicReload(unittest.TestCase):
    ...
    def test_reload_config_function_exists(self):
        ...
        from enkrypt_security.hooks.providers.kiro import reload_config
        self.assertTrue(callable(reload_config))

    def test_flush_logs_function_exists(self):
        """Test flush_logs function exists."""
        from enkrypt_security.hooks.providers.kiro import flush_logs
...
class TestKiroSpecificFeatures(unittest.TestCase):
    ...
    def test_sensitive_file_patterns_loaded(self):
        ...
        from enkrypt_security.hooks.providers.kiro import SENSITIVE_FILE_PATTERNS
    ...
    def test_hook_policies_for_kiro(self):
        ...
        from enkrypt_security.hooks.providers.kiro import HOOK_POLICIES
