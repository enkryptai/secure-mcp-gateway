...
from enkryptai_agent_security.hooks.providers.crewai import (
...
class TestMetricsCollector(unittest.TestCase):
    ...
    def test_record_call(self):
        ...
        from enkryptai_agent_security.hooks.providers.crewai import _core
...
class TestHookFunctions(unittest.TestCase):
    ...
    @patch('enkryptai_agent_security.hooks.providers.crewai.check_with_enkrypt_api')
...
class TestCheckWithEnkryptApi(unittest.TestCase):
    ...
    @patch('enkryptai_agent_security.hooks.providers.crewai.is_hook_enabled')
