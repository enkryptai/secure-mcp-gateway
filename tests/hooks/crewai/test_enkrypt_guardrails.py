...
from enkrypt_security.hooks.providers.crewai import (
...
class TestMetricsCollector(unittest.TestCase):
    ...
    def setUp(self):
        ...
        from enkrypt_security.hooks.providers.crewai import reset_metrics
        reset_metrics()

    def test_record_call(self):
        """Test recording a hook call."""
        from enkrypt_security.hooks.providers.crewai import metrics, get_hook_metrics
    ...
    def test_reset_metrics(self):
        ...
        from enkrypt_security.hooks.providers.crewai import metrics, get_hook_metrics, reset_metrics
        metrics.record_call("before_llm_call", blocked=False, latency_ms=100.0)
...
class TestConfigValidation(unittest.TestCase):
    ...
    def test_valid_config(self):
        ...
        from enkrypt_security.hooks.providers.crewai import validate_config
        config = {
            "enkrypt_api": {
...
class TestConnectionPooling(unittest.TestCase):
    ...
    def test_session_creation(self):
        ...
        from enkrypt_security.hooks.providers.crewai import get_http_session
    ...
    def test_close_session(self):
        ...
        from enkrypt_security.hooks.providers.crewai import get_http_session, close_http_session
        session = get_http_session()
        self.assertIsNotNone(session)
        close_http_session()
...
class TestBufferedLogger(unittest.TestCase):
    ...
    def test_buffered_logger_creation(self):
        ...
        from enkrypt_security.hooks.providers.crewai import BufferedLogger
...
class TestLogRetention(unittest.TestCase):
    ...
    def test_log_retention_days_default(self):
        ...
        from enkrypt_security.hooks.providers.crewai import LOG_RETENTION_DAYS
    ...
    def test_cleanup_old_logs_exists(self):
        ...
        from enkrypt_security.hooks.providers.crewai import cleanup_old_logs
        self.assertTrue(callable(cleanup_old_logs))

    def test_log_dir_exists(self):
        """Test LOG_DIR is defined."""
        from enkrypt_security.hooks.providers.crewai import LOG_DIR
...
class TestDynamicReload(unittest.TestCase):
    ...
    def test_reload_config_function_exists(self):
        ...
        from enkrypt_security.hooks.providers.crewai import reload_config
        self.assertTrue(callable(reload_config))

    def test_flush_logs_function_exists(self):
        """Test flush_logs function exists."""
        from enkrypt_security.hooks.providers.crewai import flush_logs
...
class TestSourceEvent(unittest.TestCase):
    ...
    def test_get_source_event(self):
        ...
        from enkrypt_security.hooks.providers.crewai import get_source_event
...
class TestHookFunctions(unittest.TestCase):
    ...
    @patch('enkrypt_security.hooks.providers.crewai.check_with_enkrypt_api')
...
class TestContextManager(unittest.TestCase):
    ...
    def test_context_manager_creation(self):
        ...
        from enkrypt_security.hooks.providers.crewai import EnkryptGuardrailsContext
...
class TestConvenienceFunctions(unittest.TestCase):
    ...
    def test_enable_guardrails_function_exists(self):
        ...
        from enkrypt_security.hooks.providers.crewai import enable_guardrails
    ...
    def test_disable_guardrails_function_exists(self):
        ...
        from enkrypt_security.hooks.providers.crewai import disable_guardrails
    ...
    def test_with_guardrails_decorator_exists(self):
        ...
        from enkrypt_security.hooks.providers.crewai import with_guardrails
...
class TestLoggingFunctions(unittest.TestCase):
    ...
    def test_get_timestamp(self):
        ...
        from enkrypt_security.hooks.providers.crewai import get_timestamp
    ...
    def test_log_event_function_exists(self):
        ...
        from enkrypt_security.hooks.providers.crewai import log_event
    ...
    def test_log_security_alert_function_exists(self):
        ...
        from enkrypt_security.hooks.providers.crewai import log_security_alert
...
class TestCheckWithEnkryptApi(unittest.TestCase):
    ...
    @patch('enkrypt_security.hooks.providers.crewai.is_hook_enabled')
    ...
    @patch('enkrypt_security.hooks.providers.crewai.is_hook_enabled')
    @patch('enkrypt_security.hooks.providers.crewai.get_http_session')
