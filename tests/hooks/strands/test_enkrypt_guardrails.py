...
from enkrypt_security.hooks.providers.strands import (
...
class TestSensitiveToolDetection(unittest.TestCase):
    ...
    def test_exact_match(self):
        ...
        from enkrypt_security.hooks.providers.strands import SENSITIVE_TOOLS
...
class TestMetricsCollector(unittest.TestCase):
    ...
    def setUp(self):
        ...
        from enkrypt_security.hooks.providers.strands import reset_metrics
        reset_metrics()

    def test_record_call(self):
        """Test recording a hook call."""
        from enkrypt_security.hooks.providers.strands import metrics, get_metrics
...
class TestConnectionPooling(unittest.TestCase):
    ...
    def test_session_creation(self):
        ...
        from enkrypt_security.hooks.providers.strands import get_http_session
...
class TestPrecompiledPatterns(unittest.TestCase):
    ...
    def test_patterns_are_compiled(self):
        ...
        import re
        from enkrypt_security.hooks.providers.strands import SENSITIVE_PATTERNS
...
class TestBufferedLogger(unittest.TestCase):
    ...
    def test_buffered_logger_creation(self):
        ...
        from enkrypt_security.hooks.providers.strands import BufferedLogger
...
class TestStrandsHookProvider(unittest.TestCase):
    ...
    def test_hook_import(self):
        ...
        from enkrypt_security.hooks.wrappers.strands_hook import (
    ...
    def test_audit_hook_settings(self):
        ...
        from enkrypt_security.hooks.wrappers.strands_hook import EnkryptGuardrailsAuditHook
...
class TestStrandsHookEvents(unittest.TestCase):
    ...
    def test_hook_policies_for_strands(self):
        ...
        from enkrypt_security.hooks.providers.strands import HOOK_POLICIES
        strands_hooks = [
    ...
    def test_get_source_event_mapping(self):
        ...
        from enkrypt_security.hooks.providers.strands import get_source_event
